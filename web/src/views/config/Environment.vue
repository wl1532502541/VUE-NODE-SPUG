<template>
  <a-card>
    ...
    <a-form layout="horizontal" :label-col="{flex:'100px'}" :wrapper-col="{flex:'auto'}">
      <a-row :gutter="48">
        <a-col :sm="24" :md="6">
    ...
    <div style="margin: 0 0 16px">
      ...
      <a-modal title="新建模板" :visible="newHost.visible" :confirm-loading="newHost.confirmLoading" ok-text="确定" cancel-text="取消" @ok="handleOk(newHost)" @cancel="setVisible(newHost,false)" width="800px">
        s
      </a-modal>
      ...
      <a-modal title="新建模板" :visible="importHost.visible" :confirm-loading="importHost.confirmLoading" ok-text="确定" cancel-text="取消" @ok="handleOk(importHost)" @cancel="setVisible(importHost,false)" width="800px">
        s
      </a-modal>
    </div>
